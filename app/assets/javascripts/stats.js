...
var Stats = function(dispatcher,channel) {
  ...
  var update_score = function(game_id,new_score) {
    ...
    dispatcher.trigger("update_score", { game_id: game_id, score: new_score });
  }

  var update_kills = function(game_id,new_kills) {
    dispatcher.trigger("update_kills", { game_id: game_id, kills: new_kills });
  }

  var update_deaths = function(game_id,new_deaths) {
    dispatcher.trigger("update_deaths", { game_id: game_id, deaths: new_deaths })
  }
